      ...
      <div class="box">
        <div class="floor">
          <div class="left">
            ...
            <div class="user">
              {{ post_detail.article_user }}
            </div>
          </div>
          <div class="right">
            <div class="content">
              {{ post_detail.article_content }}
            </div>
            <div class="info">
              1楼&nbsp;&nbsp;{{ post_detail.article_time }}
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="box" v-for="(item, index) in review_all_list" :key="index">
        <div class="floor">
          ...
          <div class="right">
            ...
            <div class="info">{{index+2}}楼&nbsp;&nbsp;{{ item.review_sdTime }}</div>
          </div>
        </div>
      </div>
    </div>
...
export default class module extends Vue {
  ...
  public get_post_list() {
    ...
    this.post_list.map((item) => {
      if (item.article_id.id == this.article_id) {
        this.post_detail = item.article_id;
      }
    });
  }
    ...
    if (this.loading == false) {
      ...
      if (this.review_content) {
        ...
        let review = {
          ...
          review_articleID: this.post_detail.article_user,
